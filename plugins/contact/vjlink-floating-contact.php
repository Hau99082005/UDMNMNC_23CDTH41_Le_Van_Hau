...
class VJLink_Floating_Contact {
    ...
    public function add_floating_button() {
        $phone_number = get_option('vjlink_contact_phone', '0367722389');
        $whatsapp_number = get_option('vjlink_whatsapp_number', '0367722389');
        $zalo_number = get_option('vjlink_zalo_number', '0367722389');
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="vjlink_contact_phone" name="vjlink_contact_phone" 
                                   value="<?php echo esc_attr(get_option('vjlink_contact_phone', '0367722389')); ?>" 
                                   class="regular-text">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="vjlink_whatsapp_number" name="vjlink_whatsapp_number" 
                                   value="<?php echo esc_attr(get_option('vjlink_whatsapp_number', '84987654321')); ?>" 
                                   class="regular-text">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="vjlink_zalo_number" name="vjlink_zalo_number" 
                                   value="<?php echo esc_attr(get_option('vjlink_zalo_number', '84367722389')); ?>" 
                                   class="regular-text">
